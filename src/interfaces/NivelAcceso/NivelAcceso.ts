...
export type NivelAccesoInputType = {
    nombre: string,
    descripcion: string,
    idRol: number,
    permisos: number[]
...
export class Convert {
    public static toNivelAccesoOutput(json: string): NivelAccesoOutput {
        return JSON.parse(json);
    }

    public static nivelAccesoOutputToJson(value: NivelAccesoOutput): string {
        return JSON.stringify(value);
    }

    public static toNivelAccesoOutputPageble(json: string): NivelAccesoOutputPageble {
        return cast(JSON.parse(json), r("NivelAccesoOutputPageble"));
    }

    public static nivelAccesoOutputPagebleToJson(value: NivelAccesoOutputPageble): string {
        return JSON.stringify(uncast(value, r("NivelAccesoOutputPageble")), null, 2);
    }
}
...
const typeMap: any = {
    ...
    "Content": o([
        ...
        { json: "rol", js: "rol", typ: r("Rol") },
        { json: "activo", js: "activo", typ: "" },
        { json: "usuariosConNivel", js: "usuariosConNivel", typ: 0 },
    ], false),
    "Rol": o([
        { json: "id", js: "id", typ: 0 },
        { json: "nombre", js: "nombre", typ: "" },
        { json: "descripcion", js: "descripcion", typ: "" },
        { json: "usuariosConRol", js: "usuariosConRol", typ: 0 },
    ], false),
    "Pageable": o([
