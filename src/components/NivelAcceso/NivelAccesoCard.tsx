...
interface NivelAccesoCardProps {
  nivelAcceso: import('../../interfaces/NivelAcceso/NivelAcceso').NivelAccesoItem
  onUpdate: (id: number) => void;
  onDelete: (nivelAcceso: NivelAccesoItem) => void;
  onReactivate: (nivelAcceso: NivelAccesoItem) => void
}

const NivelAccesoCard: React.FC<NivelAccesoCardProps> = ({
  nivelAcceso,
  onUpdate,
  onDelete,
  onReactivate
  ...
  return (
    ...
    >
      ...
      >
          ...
          <div className="flex justify-between items-start min-h-10">
            ...
            <div className="flex space-x-1">
              {nivelAcceso.activo == "ACTIVO" ? (
                  ...
                  <>
                    <Tippy content="Editar Gimnasio" placement="top" animation="scale">
                      <IconButton
                        ...
                        color="blue"
                        size="md"
                        onClick={() => onUpdate(nivelAcceso.id)}
                    ...
                    <Tippy content="Desactivar Nivel" placement="top" animation="scale">
                      <IconButton
                        variant="gradient"
                        color="red"
                        size="md"
                ...
                <Tippy content="Reactivar Nivel" placement="top" animation="scale">
                  <IconButton
                    variant="gradient"
                    color="green"
                    size="md"
        ...
        <div className={`px-5 py-3 bg-gray-50 border-t border-gray-100 flex ${nivelAcceso.id > 4 && nivelAcceso.activo === "ACTIVO" ? "justify-between" : "justify-end"} items-center`}>
          {nivelAcceso.id > 4 && nivelAcceso.activo === "ACTIVO" && (
            <NormalButton
              onClick={() => onUpdate(nivelAcceso.id)}
          ...
          <NormalButton
            onClick={() => navigate(`/admin/niveles-acceso/${nivelAcceso.id}`)}
            tooltip='Ver Más'
          >
            <FaEye />
            Ver Más
